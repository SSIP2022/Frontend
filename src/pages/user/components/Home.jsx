        ...
        <>
          <div className={home.top}>
            <div className={home.greetings}>
              ...
              <div className={home.greetings_welcome}>Register your complain</div>
            </div>
          ...
          <div className={home.iconcontainer}>
            <div className={home.icon}><GiElectric />Electricity</div>
            <div className={home.icon}><IoWater />Water</div>
            <div className={home.icon}><FaTrashAlt />Cleaning</div>
            <div className={home.icon}><GiHealthNormal />Health</div>
            <div className={home.icon}><BiDotsHorizontalRounded />Others</div>
          </div>
          {/*           
