            ...
            <table className={track.table}>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button type="button" className={track.close}>
                      Resolved
                    </button>
                    <button type="button" className={track.inprogressbtn}>
                      In Progress
                    </button>   
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td data-label="Staus" className="inprogress">
                    In Progress
                  </td>
                  <td data-label="Date">4/10/2022</td>
                  <td>
                ...
                <tr>
                  ...
                  <td data-label="Dept">Electric</td>
                  <td data-label="Staus" className="fail">
                    Failed
                  </td>
                  <td data-label="Date">4/10/2022</td>
                  <td>
